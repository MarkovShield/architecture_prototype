package ch.hsr.markovshield.kafkastream.interactive_query.web;
...
public class MarkovRestEndpoint {
    ...
    @GET
    @Path ("/validatedclickstreams/before/{timestamp}")
    @Produces (MediaType.APPLICATION_JSON)
    public List<ValidatedClickStream> getValidatedClickstreamBeforeTimeStamp(@PathParam ("timestamp") final Long timestamp) {
        return validatedClickstreamService.getValidatedClickstreamBeforeTimeStamp(timestamp);
    }
    ...
    public List<HostStoreInfo> streamsMetadata() {
        return metadataRepository.streamsMetadata();
    }
    ...
    public List<HostStoreInfo> streamsMetadataForStore(@PathParam ("storeName") String store) {
        return metadataRepository.streamsMetadataForStore(store);
    }
