...
import ch.hsr.markovshield.flink.serialization.ValidatedClickStreamSerializationSchema;
import ch.hsr.markovshield.flink.serialization.ValidationClickStreamDeserializationSchema;
    ...
    private static void executeAnalysis(final CommandLine commandLineArguments) throws Exception {
        ...
        DataStreamSource<ValidationClickStream> stream = env
            .addSource(new FlinkKafkaConsumer010<>(MarkovTopics.MARKOV_CLICK_STREAM_ANALYSIS_TOPIC,
                new ValidationClickStreamDeserializationSchema(JsonPOJOSerde.MARKOV_SHIELD_SMILE),
